...
%token OF FUNCTION PROCEDURE TPROGRAM TBEGIN TEND WHILE FOR TO DO AND NOT ASIGNATION_VARIABLE QUOTATIONS 
...
COMPOSED_INSTRUCTION : TBEGIN OPTIONAL_INTRUCTIONS TEND
	;
